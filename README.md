...
Поточний акцент візуалізації — **heatmap Харківської області** за кількістю охоплених бенефіціарів у сесіях.

## Файли
- `index.html` — сторінка з картою.
- `data/sessions.geojson` — демо-точки проведених сесій.
- `data/admin_agg.geojson` — демо-полігони громад з сумою учасників (спрощені, неофіційні межі, використані лише як допоміжний демонстраційний шар).
